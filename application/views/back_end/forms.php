                ...
                <form class="form-horizontal bordered-group" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input class="form-control mb15 input-lg" type="text" placeholder=".input-lg">

                      <input class="form-control mb15" type="text" placeholder="Default input">

                      <input class="form-control mb15 input-sm" type="text" placeholder=".input-sm">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group mb15">
                        ...
                        <input type="text" class="form-control bl0">
                      </div>

                      <div class="input-group mb15">
                        <input type="text" class="form-control br0">
                        <span class="input-group-btn">
